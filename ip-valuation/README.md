...
- 사업화주체 원가율·판관비율도 같은 방식으로 병합합니다. PDF와 붙여넣기의 중복연도는 교차검증하고, 붙여넣기 추가연도는 보존하여 수익구조 비교에 최대 5개년을 적용합니다.
- PDF에 없는 연도는 임의로 0 또는 추정치로 채우지 않습니다. 성장률·수익구조·자기자본비율의 기간 선택지는 병합 후 실제 유효자료 수에 맞춰 제한되며, 수익구조는 사업화주체와 동업종의 최신 유효기간을 각각 같은 개수로 비교합니다.
